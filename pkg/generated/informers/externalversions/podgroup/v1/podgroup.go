...
import (
	...
	versioned "github.com/tenstack/batch-scheduler/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/tenstack/batch-scheduler/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/tenstack/batch-scheduler/pkg/generated/listers/podgroup/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.BatchV1().PodGroups(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BatchV1().PodGroups(namespace).Watch(options)
			},
		},
		&podgroupv1.PodGroup{},
		resyncPeriod,
...
func (f *podGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&podgroupv1.PodGroup{}, f.defaultInformer)
}
