...
import (
	...
	"github.com/tenstack/batch-scheduler/pkg/generated/clientset/versioned/scheme"
...
// BatchV1Client is used to interact with features provided by the batch.scheduler.tencent.com group.
type BatchV1Client struct {
	restClient rest.Interface
}

func (c *BatchV1Client) PodGroups(namespace string) PodGroupInterface {
